...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            'hosts': [
                (REDIS_HOST,REDIS_PORT,REDIS_DB_CHANNELS)
            ],
        },
    },
}
...
DEFAULT_STORAGE = 'r2'  # or 'cloudinary'
...
#zegocloud
ZEGOCLOUD_APP_ID = env('ZEGOCLOUD_APP_ID')
ZEGOCLOUD_SERVER_SECRET = env('ZEGOCLOUD_SERVER_SECRET')
...
CELERY_RESULT_BACKEND = f'redis://{REDIS_HOST}:{REDIS_PORT}/{REDIS_DB_CELERY_RESULTS}'
